...
const createSendToken = (user, statusCode, res) => {
    ...
    // Remove the password and the isActive from output
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    if(!(await user.correctPassword(req.body.passwordCurrent, user.password))) return next(new AppError('Your old password does not match! Try again.', 401));
